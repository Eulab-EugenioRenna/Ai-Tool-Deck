...
import { PlusCircle, Bot, RefreshCcwDot } from 'lucide-react'; // Added Bot icon for logo and RefreshCcwDot
...
export function Navbar({ onAddToolClick, onUpdateAllToolsClick, isUpdatingAllTools }: NavbarProps) {
  return (
